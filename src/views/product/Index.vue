                                  ...
                                  <div class="quick-view__left-content">
                                    <div class="tabs">
                                      <div class="popup-product-thumb-box">
                                        <ul>
                                          <li v-for="popupImage in popupProduct.images"
                                              class="tab-nav popup-product-thumb">
                                            <a :href="`#tabb${popupImage.id}`">
                                      ...
                                      <div class="popup-product-main-image-box">
                                        <div v-for="popupImage in popupProduct.images" :id="`tabb${popupImage.id}`"
                                  ...
                                  <div class="popup-right-content">
                                    ...
                                    <div class="color-varient">
                                      <template v-for="groupProduct in popupProduct.group_products">
                                        <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" :style="`background:${color.title}`" href="#0" class="color-name"> </a>
                                      </template>
                                    </div>
              ...
              <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                <ul class="pagination text-center">
                  ...
                  <li v-for="link in this.pagination.links">
                    ...
                    ">
                      <a href="#" @click.prevent="getProducts(link.label)" :class="link.active ? 'active' : ''">{{ link.label }}</a>
                    </template>
                    <template v-if="Number(link.label) &&
                    pagination.current_page !== 3 &&
                    (pagination.current_page - link.label === 2) || Number(link.label) &&
                  ...
                  <li class="next" v-if="pagination.current_page !== pagination.last_page">
                    <a @click.prevent="getProducts(pagination.current_page + 1)"><i class="flaticon-next-1" aria-hidden="true"></i> </a>
                  </li>
                </ul>
              </div>
            </div>
...
export default {
  ...
  methods:{
    ...
    getFilterList(){
      this.axios.get(`http://localhost/api/products/filters`)
          .then(res => {
